...
const UniUpdatesSource = require('./uniUpdates');
...
const AVAILABLE_SOURCE_TYPES = [
  ...
  { id: 'uni_updates', label: 'University verified updates (all categories)', produces: 'university', reliability: 10 },
  { id: 'weather', label: 'St Andrews weather (Open-Meteo)', produces: 'town', reliability: 8 },
];
